...
COMMON+= -DOPENCV
CFLAGS+= -DOPENCV
LDFLAGS+= `PKG_CONFIG_PATH=/usr/lib/x86_64-linux-gnu/pkgconfig pkg-config --libs opencv` 
COMMON+= `PKG_CONFIG_PATH=/usr/lib/x86_64-linux-gnu/pkgconfig pkg-config --cflags opencv` 
endif
...
COMMON+= -DCUDNN 
CFLAGS+= -DCUDNN
LDFLAGS+= -L/usr/lib/x86_64-linux-gnu -lcudnn
endif
